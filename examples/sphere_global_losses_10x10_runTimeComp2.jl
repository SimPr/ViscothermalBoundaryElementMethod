# Compute solution for pa (10n-direct) without extra steps to track total runtime and memory
# Call with /usr/bin/time -v julia --project=.  ./examples/sphere_global_losses_10x10_runTimeComp2.jl --freq 100 --mesh_file "sphere_1m_coarser"
...
===========================================================================================#
@info "Computing setup pa 10x10 dense $(M)DOFs freq$(Int(freq))"
