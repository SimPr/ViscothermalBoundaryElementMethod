# Better name would be sphere_global_losses_conditionNumbers
# Compute condition numbers of G/H and system matrix auf 1n- iter, 1n - direct, 4n - direct and 10n - direct system
# Call with julia --project=.  ./examples/paper1_comparisons1.jl
...
mesh_files = ["sphere_1m_coarser","sphere_1m_coarse","sphere_1m","sphere_1m_fine","sphere_1m_finer"] # Just as a start
...
for freq in [100.0,500.0,1000.0]
    ...
    for mesh_file in mesh_files
        ...
        data_file = joinpath(mesh_file, "cond_$(n)DOFs_freq$(Int(freq)).jld2");
        ...
        # Saving data
        jldsave("cond_$(n)DOFs_freq$(Int(freq)).jld2", 
                condF1=condF1,
                condF4=condF4,
                condF10=condF10,
                condGa=condGa,
