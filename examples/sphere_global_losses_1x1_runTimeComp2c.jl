# Compute solution for paFMM (1n-FMM) without extra steps to track total runtime and memory
# Call with /usr/bin/time -v julia --project=.  ./examples/sphere_global_losses_1x1_runTimeComp2c.jl --freq 100 --mesh_file "sphere_1m_coarser"
...
#===========================================================================================
                        FMM BEM matrix assembly and iterative solution of the 1-variable system
===========================================================================================#
